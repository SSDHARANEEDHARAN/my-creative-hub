              ...
              {view === "login" && (
                ...
                >
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <Button type="button" variant="outline" className="w-full h-12" disabled={isGoogleLoading || isAppleLoading} onClick={handleAppleLogin}>
                      {isAppleLoading ? <Loader2 className="w-5 h-5 mr-2 animate-spin" /> : (
