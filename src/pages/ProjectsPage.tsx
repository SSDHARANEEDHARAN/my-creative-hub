...
import { Cpu, Cog, ExternalLink, Github, ArrowUpRight } from "lucide-react";
...
const ProjectsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Projects | Tharanee Tharan S.S - Full Stack Developer & CAD Engineer</title>
        <meta name="description" content="Explore portfolio of IT and Engineering projects including web apps, embedded systems, CAD designs, and simulations." />
      </Helmet>
