...
const ProjectsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Projects | Alex Chen - Creative Developer</title>
        <meta name="description" content="Explore Alex Chen's portfolio of web development projects including e-commerce, analytics dashboards, and mobile apps." />
      </Helmet>
            ...
            <div className="container mx-auto px-6">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                {featuredProjects.map((project, index) => (
                  <ScrollReveal key={project.id} delay={index * 100}>
                    <div className="group bg-card rounded-3xl overflow-hidden border border-border hover:border-primary/50 hover:shadow-lg transition-all duration-300">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {otherProjects.map((project, index) => (
                  <ScrollReveal key={project.id} delay={index * 100}>
                    <div className="group bg-card rounded-2xl overflow-hidden border border-border hover:border-primary/50 hover:shadow-lg transition-all duration-300 p-5">
