...
const ArticlePage = memo(() => {
  ...
  return (
    <>
      <Helmet>
        <title>{article.title} | Case Study - SS. Tharan</title>
          ...
          <section ref={contentRef} className="py-8 sm:py-12 md:py-16">
            <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
              ...
              >
                ...
                {project?.mediaFolderUrl && (
                  <div className="mb-6 rounded-xl overflow-hidden border border-border bg-card shadow-lg aspect-video">
                    <iframe
                      src={`https://drive.google.com/embeddedfolderview?id=${project.mediaFolderUrl.match(/folders\/([^?]+)/)?.[1] ?? ""}#grid`}
                      title={`${article.title} media gallery`}
