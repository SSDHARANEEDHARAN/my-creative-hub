...
export const articleContents: ArticleContent[] = [
  ...
  {
    id: 129,
    slug: "inverted-pendulum-linear-cart",
    title: "Inverted Pendulum Linear Cart Control System",
    subtitle: "Real-time closed-loop stabilization and inverted pendulum balancing with PID/LQR control",
    duration: "4 weeks",
    client: "Personal Engineering / Control Systems Project",
    role: "Mechatronics Control Systems Engineer & Embedded Developer",
    industry: "Robotics / Control Systems Engineering / Embedded Automation",
    teamSize: "1 Developer",
    overview: "The Inverted Pendulum Linear Cart Control System is a dynamic control engineering platform built to solve the classic unstable inverted pendulum problem. An ESP32 microcontroller reads high-frequency angular feedback from a 2500 CPR incremental rotary encoder and calculates horizontal counter-movements. A belt-driven cart then accelerates along a linear rail to catch the falling pendulum and maintain upright equilibrium, including recovery from external disturbances.",
    challenge: "The unstable and nonlinear system required fast feedback, reliable quadrature decoding, low mechanical backlash, and careful controller tuning. The control loop had to react before the pendulum fell while avoiding rail overshoot, belt latency, and high-frequency mechanical resonance.",
    solution: "Integrated an ESP32 dual-core 240 MHz controller with a 2500 CPR incremental encoder and TMC5160 silent high-precision stepper driver. The embedded C++ control stack combines encoder feedback with PID/LQR control logic to command rapid cart corrections and recover balance after physical perturbations.",
    process: [
      { title: "Mechanical Platform", content: "Built the belt-driven linear cart and pendulum assembly on a guided rail, focusing on stiffness, low friction, and reduced backlash for predictable control response." },
      { title: "Feedback Sensing", content: "Mounted and decoded a 2500 CPR incremental rotary encoder to measure pendulum angle and provide high-resolution state feedback during rapid movement." },
      { title: "Embedded Control", content: "Implemented the real-time control loop in C++ on an ESP32 dual-core 240 MHz microcontroller, with high-speed quadrature handling and deterministic motor command updates." },
      { title: "Motor Drive Integration", content: "Integrated the TMC5160 stepper driver for quiet, high-resolution cart motion and precise acceleration and direction control." },
      { title: "Controller Tuning", content: "Tuned PID and LQR parameters to balance responsiveness, disturbance recovery, rail travel, and resonance suppression." }
    ],
    results: [
      "Real-time closed-loop inverted pendulum stabilization",
      "High-resolution angular feedback from a 2500 CPR encoder",
      "Fast cart corrections through TMC5160 stepper control",
      "ESP32-based embedded C++ control platform",
      "Disturbance recovery with tuned PID/LQR control"
    ],
    technologies: ["C++", "ESP32", "PID Control", "LQR Control", "Incremental Rotary Encoder", "TMC5160", "Stepper Motor", "Quadrature Decoding", "Real-Time Embedded Systems"],
    toolsUsed: ["Arduino IDE / ESP-IDF", "Oscilloscope and Serial Debugging", "Control Systems Tuning Tools", "Mechanical Fabrication Tools"],
    keyMetrics: [
      { value: "2500 CPR", label: "Encoder Resolution" },
      { value: "TMC5160", label: "Stepper Driver" },
      { value: "240 MHz", label: "ESP32 Clock" },
      { value: "PID / LQR", label: "Control Methods" }
    ],
    lessons: [
      "High-resolution feedback and deterministic timing are essential for unstable control systems",
      "Mechanical backlash and belt latency can limit controller performance as much as software tuning",
    ...
    conclusionVideoUrl: "https://drive.google.com/file/d/1QpsKFfYhkk_xR6drfJVlQoW_-sYphUqe/view"
  },
  {
    id: 130,
    slug: "arduino-drawing-plotter",
    title: "Arduino Drawing Plotter",
    subtitle: "An Arduino-controlled XY pen plotter for converting digital designs into physical drawings",
    duration: "4 weeks",
    client: "Personal Mechatronics Project",
    role: "Mechatronics Engineer & Embedded Developer",
    industry: "Robotics / Embedded Automation / Digital Fabrication",
    teamSize: "1 Developer",
    overview: "The Arduino Drawing Plotter is a compact mechatronics system that translates digital drawing commands into coordinated XY motion. Stepper motors position the pen across the working area while a servo mechanism lifts and lowers the pen to create clean, repeatable plotted lines.",
    challenge: "The system required accurate belt and rail alignment, synchronized stepper movement, reliable pen-lift timing, and smooth motion so the plotted output matched the source drawing without skips, vibration, or unwanted marks.",
    solution: "Built an Arduino-based motion controller using C++ stepper sequencing and servo pen-lift control. The mechanical frame, guided axes, motor drive, and pen mechanism were tuned together to produce repeatable drawing motion across the work surface.",
    process: [
      { title: "Mechanical Assembly", content: "Assembled the XY frame, linear guides, belts, pulleys, and pen holder to create a stable and repeatable plotting platform." },
      { title: "Motion Control", content: "Programmed coordinated stepper motor movement in C++ to control X and Y positioning with controlled acceleration and direction changes." },
      { title: "Pen Lift Mechanism", content: "Integrated a servo actuator to raise and lower the pen at drawing command boundaries, preventing unwanted lines between shapes." },
      { title: "Calibration & Testing", content: "Calibrated axis travel, step resolution, working-area limits, and pen pressure through repeated plotting tests." }
    ],
    results: [
      "Built a functional Arduino XY drawing plotter",
      "Converted digital paths into physical pen movement",
      "Implemented coordinated stepper motor positioning",
      "Added servo-controlled pen lift and drop operation",
      "Improved repeatability through axis and pen calibration"
    ],
    technologies: ["Arduino", "C++", "Stepper Motors", "Servo Motor", "Belt Drive", "XY Motion Control", "Embedded Systems"],
    toolsUsed: ["Arduino IDE", "CAD / Mechanical Fabrication Tools", "Serial Debugging", "Hand Tools"],
    keyMetrics: [
      { value: "2-Axis", label: "XY Motion" },
      { value: "Arduino", label: "Controller" },
      { value: "Servo", label: "Pen Lift" },
      { value: "C++", label: "Firmware" }
    ],
    lessons: [
      "Mechanical alignment directly affects plotted line accuracy",
      "Smooth stepper timing reduces vibration and improves drawing quality",
    ...
    conclusionVideoUrl: "https://drive.google.com/file/d/1WrhGGMJ9Az5C3tWdale2eHdiLw6ssHgn/view"
  },
];
