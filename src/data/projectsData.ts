...
export const industrialProjects: Project[] = [
  ...
  },
  {
    ...
    images: [mms1, mms10, mms9, mms2, mms3, mms4, mms5, mms6, mms7, mms8, mms11, mms12, mms13, mms14, mms15, mms16, mms17, mms18, mms19, mms20, mms21, mms22, mms23, mms24],
  ...
  },
  {
    ...
    description: "Compact aluminum-framed conveyor system with variable speed motor drive, designed for laboratory automation and small production environments.",
...
export const engineeringProjects: Project[] = [
  ...
  },
  {
    ...
    videoUrl: "https://drive.google.com/file/d/1QpsKFfYhkk_xR6drfJVlQoW_-sYphUqe/preview",
    featured: true,
    category: "engineering",
    },
    {
