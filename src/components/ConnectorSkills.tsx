...
const connectors: Connector[] = [
  ...
  { name: "Lovable Cloud", description: "Backend, database & auth hosting platform", url: "https://lovable.dev/" },
  { name: "Lovable AI", description: "AI Gateway for chat, image & speech models", url: "https://lovable.dev/" },
