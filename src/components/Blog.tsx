...
const initialPosts: Omit<BlogPost, 'likes' | 'comments'>[] = [
  {
    ...
    readTime: "5 min read",
    category: "Technology",
    author: { name: "SS. Tharan", avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop" },
  },
  {
    id: 2,
                        ...
                        {comment.reply && (
                          <div className="ml-10 mt-3 pl-4 border-l-2 border-primary">
                            <div className="flex items-center gap-2 mb-1">
                              <span className="text-xs font-medium text-primary">SS. Tharan</span>
